...
public class PaymentprocessingVarArgsExample 
{
	...
	;
       DebitCard debitCard = new DebitCard();
		...
		paymentProcessing(debitCard,upi,creditCard);
	}
	
	public static void paymentProcessing(Payment ... payments)//Loose coupling mean we can pass the any sub class object to the parameter variable
	{
...
//   Its all Class Are already declared inside the class PaymentProcessing  that reason here commented
//
//class Payment
//{
//	
