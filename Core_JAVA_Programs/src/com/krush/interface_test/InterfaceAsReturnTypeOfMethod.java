...
public class InterfaceAsReturnTypeOfMethod {
	public static Games getGame(int choice) //we can use the interface name as a return type means we can pass any implimenter Object 
	                //we can achived more the flexibity to pass any object that is factory method  because its create a object
	{
